...
`Custom Cursor` • `Project Showcase`

`Responsive Design` • `Smooth Motion`
...
![File Handling](https://img.shields.io/badge/File_Handling-2563EB?style=flat-square)
![Structures](https://img.shields.io/badge/Structures-7C3AED?style=flat-square)
![CLI](https://img.shields.io/badge/Command_Line-111827?style=flat-square)
...
🎙️ Real-time voice applications
...
I want every project to help me learn something practical,
solve a real problem or express a creative idea.

For me, development is where logic meets creativity.
```
